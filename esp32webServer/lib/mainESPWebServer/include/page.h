...
font-size: xx-large;">
    <button style = "position: fixed; top: 10px; left: 10px; background-color: rgba(255, 0, 0, 0.7); color: white; padding: 5px; font-size: 16px; border-radius: 5px;"onclick="fullStop()">Emergency Stop</button>
